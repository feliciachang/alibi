export default function sketch(p){
    ...
    p.draw = () => {
      ...
      p.image(img, 17, 50);
      p.image(img, 120, 50);
      p.image(img, window.innerWidth - 500, 50);

      p.noFill();
      p.stroke(0, 90, 102, 50);
      p.ellipse(window.innerWidth/2, 100, p.mouseX/5, p.mouseX/5);
